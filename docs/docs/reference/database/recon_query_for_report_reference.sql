/*
  ...
  Replace REPLACE_WITH_CLIENT_UUID with clients.client_id, then run this query
  in Supabase SQL Editor. Set report_week only when rebuilding a past report.
*/

WITH
params AS (
  SELECT
    '88bbe237-718e-456b-8709-313708c53b15'::uuid AS client_id,
    NULL::date AS report_week,       -- e.g. DATE '2026-07-20'; NULL = latest
    16::integer AS sov_history_weeks
),
